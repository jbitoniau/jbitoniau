	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				'Get this page running on a Chrome Mobile tablet Touch buttons, everything work fine Plug in a mouse and click on the first button BAM: another button get a enter/leave event!',
