		...
		render: function() 
		{
			...
			return ( 
					...
					React.createElement("div", {style: mainDivStyle}, 
						...
						React.createElement("div", {style: {flex:'none', height:barHeight}}, 
									
								React.createElement("div", {style: {position:'relative', width:'100%', height:'100%', border:'1px solid yellow'}}, 
									...
									React.createElement("div", {style: {position:'absolute', 
										...
										React.createElement("div", {style: {position:'relative', width:'100%', height:'100%'}}, 
											...
											React.createElement("div", {style: {position:'absolute', 
												...
												React.createElement("div", {style: {position:'relative', top:-knobHeight/2, left:-knobWidth/2, width:knobWidth, height:knobHeight,
